...
int main(int argc, char** argv) {
  ...
  //}
  char *input = argv[1];
  if(*input != 112){//Not enough precision
    printf("Password Incorrect precision\n");
    return 1;
  }
  puts("Check 1 passed.");
  double magic_numbers[7] ={-68822144.50341525673866271972656250000000000000000000000000,
  ...
  for(int i = 0; i < 6;i++)
  {
      ...
      for(int j=0;j<7;j++)
      {
          ...
          foo *= (float)log(*(float*)((unsigned long)input+2*i));
      }
      if((int)(100000*bar) != 0){
