...
set(CMAKE_SYSROOT "${RELOCATED_HOST_DIR}/x86_64-buildroot-linux-uclibc/sysroot")
set(CMAKE_FIND_ROOT_PATH "${RELOCATED_HOST_DIR}/x86_64-buildroot-linux-uclibc/sysroot")
set(CMAKE_FIND_ROOT_PATH_MODE_PROGRAM NEVER)
set(CMAKE_FIND_ROOT_PATH_MODE_PACKAGE ONLY)
set(CMAKE_FIND_ROOT_PATH_MODE_LIBRARY ONLY)
set(CMAKE_FIND_ROOT_PATH_MODE_INCLUDE ONLY)
set(ENV{PKG_CONFIG_SYSROOT_DIR} "${RELOCATED_HOST_DIR}/x86_64-buildroot-linux-uclibc/sysroot")

# This toolchain file can be used both inside and outside Buildroot.
set(CMAKE_C_COMPILER "${RELOCATED_HOST_DIR}/bin/x86_64-buildroot-linux-uclibc-gcc")
if(0)
  ...
  set(CMAKE_CXX_COMPILER "${RELOCATED_HOST_DIR}/bin/x86_64-buildroot-linux-uclibc-g++")
endif()
if(0)
  ...
  set(CMAKE_Fortran_COMPILER "${RELOCATED_HOST_DIR}/bin/x86_64-buildroot-linux-uclibc-gfortran")
endif()
